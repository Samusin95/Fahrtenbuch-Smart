...
import 'GeneratedRegistrierung_Text_PLZWidget.dart';
...
Future<List> senddata() async {
  final response = await http.post(Uri.parse("http://10.0.63.11/testsmart/insertdata.php"), body: {
    "plz": myPlz.plz.text//"6789"//"Testemail;"//myEmail.email.text,
  });
