...
import 'generated/GeneratedFahrt_Text_StandBeginnWidget.dart';
...
/* Frame Neue Fahrt
  ...
  */
class GeneratedNeueFahrtWidget extends StatefulWidget {
  @override
  State<GeneratedNeueFahrtWidget> createState() => _GeneratedNeueFahrtWidgetState();
}

class _GeneratedNeueFahrtWidgetState extends State<GeneratedNeueFahrtWidget> {
  @override
  ...
  Future getDataStand() async{
    dynamic token = await FlutterSession().get("token");
    String url = "http://10.0.231.11/testsmart/getdataStand.php?emailtoken=" + token;
    ...
    if (response.statusCode == 200) {
      ...
      standBeginnkey.currentState.standBeginn.text = response.body as String;
    }
  }
}
